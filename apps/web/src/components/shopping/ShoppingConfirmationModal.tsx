...
import type { ShoppingConfirmation } from "./types";

interface ShoppingConfirmationModalProps {
  confirmation: ShoppingConfirmation | null;
  onApprove: () => void;
  onCancel: () => void;
}

export function ShoppingConfirmationModal({ confirmation, onApprove, onCancel }: ShoppingConfirmationModalProps) {
  return (
    <AnimatePresence>
      {confirmation ? (
        <motion.div
        ...
        >
          ...
          >
            <p className="technical-label text-textSecondary">Shopping Confirmation</p>
            ...
            <p className="mt-5 leading-7 text-textSecondary">
              BrowsePilot tidak akan add to cart, checkout, atau pembayaran tanpa izin kamu.
            </p>
